...
1. **Beden girişi** (10 dk) — Kısa bir bedensel farkındalık pratiği
2. **Kavramsal açılım** (30-45 dk) — Ayrımın teorik zemini
3. **Canlı pratik** (90-100 dk) — Gerçek durumlarla çalışma
4. **Küçük gruplar** (30 dk) — İkili/üçlü pratik
5. **Entegrasyon ve kapatma** (15 dk)

## Ne Öğreneceksiniz?

Programın sonunda:

- NVC'nin 54 anahtar ayrımını derinlemesine kavramış olacaksınız
- Günlük ilişkilerinizde bu ayrımları spontan biçimde kullanabileceksiniz
- Kendi NVC pratiğinizdeki kör noktaları fark edecek ve çalışabileceksiniz
...
Program kaydı için iletişim formunu kullanabilir veya doğrudan e-posta gönderebilirsiniz. Yeni dönem açıldığında öncelikli bildirim almak için de kayıt olabilirsiniz.
