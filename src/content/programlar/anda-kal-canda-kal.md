...
NVC hakkında hiçbir ön bilgisi olmayan herkes bu programa katılabilir. Şu arayışlardan herhangi birini taşıyorsanız bu program tam size göre:

- İlişkilerinde (aile, iş, arkadaşlık) daha iyi iletişim kurmak isteyenler
...
- NVC'nin dört adımını (gözlem, duygu, ihtiyaç, rica) tanıyacak ve uygulayacaksınız
- Günlük konuşmalarınızda NVC diline geçişler yapabileceksiniz
- Kendinizle ve başkalarıyla daha derin empati kurabileceksiniz
- Çatışma anlarında devreye girebilecek somut bir araç setine sahip olacaksınız
...
Yeni dönem tarihlerini öğrenmek veya kayıt olmak için iletişim formunu kullanabilirsiniz. Programla ilgili sorularınız için doğrudan e-posta da gönderebilirsiniz.
